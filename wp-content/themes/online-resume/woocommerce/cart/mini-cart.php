...
do_action( 'woocommerce_before_mini_cart' ); ?>
			...
			<?php 
				if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
					...
					<?php 
						...
						?>
						<span class="badge"><?php echo esc_html_e('0','online-resume'); ?></span>
						<?php 
					}
				}
			?>
		</div>
		<h3><?php _e( 'Total:', 'online-resume' ); ?> <?php echo WC()->cart->get_cart_subtotal(); ?></h3>
	</div>
				...
				<li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						...
						sprintf(
							...
							esc_attr__( 'Remove this item', 'online-resume' ),
							esc_attr( $product_id ),
	...
	<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="theme-button"><?php echo esc_html_e('Checkout','online-resume'); ?> </a>
